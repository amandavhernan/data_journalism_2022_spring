...
**A1** The majority of loans (15,089) fell under the 10k-50k category whereas the other loan amount counts vary with the 1m_plus category having the lowest number of loans in that category (356). 
...
undisbursed_lenders <- west_virginia_ppp %>%
...
**A3** It's possible the borrower didn't follow a lender's requirements or that the business closed permanently before the full loan amount could be disbursed. If this is the case, I'm curious about why a borrower wouldn't meet a lender's requirements and if this could be an indicator for flagging fraudulent applications. 
...
**A5** 10 and the loan with the earliest approved date went to J. Austin Heating & Cooling, Inc. on April 8, 2020.

```{r}
# Write the code to produce your answer here

wv_jobs <- west_virginia_ppp %>%
