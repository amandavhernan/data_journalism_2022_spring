...
plot_usmap(data = state_incarceration_data, values = "total_state_pop_20", color = "black") +
...
plot_usmap(data = state_incarceration_data, values = "total_state_pop_10", color = "black") +
  scale_fill_continuous(low = "white", high = "deep sky blue 4", name = "Population", label = scales::comma) + theme(legend.position = "right") +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0))
...
plot_usmap(data = state_incarceration_data, values = "total_state_pop_00", color = "black") +
  scale_fill_continuous(low = "white", high = "deep sky blue 4", name = "Population", label = scales::comma) + theme(legend.position = "right") +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0))
...
mapview(sf_state_incarceration_data, zcol = "total_state_pop_00")
...
southern_incarceration_rates <- state_incarceration_data %>%
