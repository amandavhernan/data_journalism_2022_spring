...
```{r}
ppp_maryland_loans <- readRDS("pre_lab_01.rds")
```
...
**Answer** There are 195,856 observations and 63 variables.
...
**Answer** The data type for the "name" column is character while the data type for the "amount" column is numeric. I believe the "name" column represents the PPP loan applicant's first and last name or business name. As for the "amount" column, my guess is that it represents the loan amount distributed per applicant. 
...
**Answer** The first five companies received $10 million loans; GSE Systems, Inc., GMS Mine Repair and Maintenance, Inc., Lemek LLC, Mission BBQ Management, LLC and PT Network, LLC. Mission BBQ, a restaurant chain, serves BBQ. 
