...
**Answer** The webpage provides an overview of industry classification, but we're interested in table 2 because it lists the two-digit sector codes with their respective industries.
...
**Answer** When viewing the source code, you can see the website's structure in HTML.
...
**Answer** It shows two values; the head and body tags.
...
**Answer** I see three columns titled "name," "type," and "value." Under the name column, I see four names: html, head, body, and xml attributes.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** There's a <table> tag with additional tags that determine the overall structure/style of the table. 
...
**Answer** The output includes six tables that were extracted the website.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** The name of the columns are "name," "type," and "value." Under name, it lists 1-6 to represent the six tibbles. Under value, it lists the length of the tibbles. 
...
**Answer** Directly under the [[1]], there are rows titled conversion, reference month implemented, and date released.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** It lists the sector and respective description for each industry.
...
**Answer** It pulled the second row and created a tibble that shows each sector and its corresponding description. 
...
**Answer** The code removed the last row, which contained sourcing information.
...
**Answer** The code returned the same NAICS sector/industry table, but it's formatted as a proper dataframe. It also standardized the column names and removed the source information.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** There are several tables related to workforce statistics in the utilities sector.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** It looks like the top of a HTML document.
...
**Answer** The code extracted the HTML table needed to create a dataframe with the data from the website.
...
**Answer** The code turned the HTML into a dataframe that lists employment numbers by month. 
...
**Answer** The code returned a dataframe with a single row that contains the number of employees.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This page shows several tables with data related to the mining sector.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This page shows several tables with data related to the construction sector.
...
**Answer** The code printed each industry.
...
**Answer** The code created a list with all of the sectors.
...
**Answer** The code printed out the list of each sector using a for loop to print each one out individually.
...
**Answer** I received an error that reads "Error in sector_list : object 'sector_list' not found"
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** The code printed out the same list of sectors.
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** The code returns an error saying the object "sector_name" was not found because it hasn't been defined yet.
...
**Answer** The code returns a list of numbers, 1-10.
...
**Answer** The codeblock displays the NAICS table containing the two-digit sector codes and corresponding industry descriptions.
...
**Answer** The code returns the number of rows, which is 20.
...
**Answer** The code prints out the number of rows in the "naics_industry" dataframe.
...
These were basic examples of how "for loops" work.  Next, we'll learn to apply "for loops" to efficiently extract information from multiple web pages.
...
**Answer** The codeblock displays the number of employees for November 2021; 536.9.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** The code returns the clean version of the NAICS sector/description dataframe.
...
**Answer** The code returns the NAICS sector/description table with a new column that contains the website URLs for each industry.
...
**Answer** The code displays the same table showed in the previous task with a new column that contains the sector_xpath_id.
...
**Answer** The code removed the row for public administration.
...
**Answer** The code returned tibbles for each row. Each tibble contains the sector number, description, URL, and sector_xpath_id for each industry.
...
**Answer** The code stores the URL and xpath code for each row.
...
**Answer** The code created separate tibbles containing employment data for each industry.
...
**Answer** The code removed the unnecessary data and created tibbles for each sector with their respective employment data under the data series, "Employment, all employees (seasonally adjusted)." 
...
**Answer** The code added the corresponding sector number and industry description to each tibble.
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** The code cleaned the dataframe so the only columns present are sector, description, and nov_2021_employees.
...
**Answer** The codeblock displays a new dataframe that contains all of the sectors, descriptions, and number of employees in November 2021.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The page shows information about the mining, quarrying, and oil and gas extraction industry.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The page shows information about the agriculture, forestry, fishing and hunting industry.
...
**Answer** The code removed the value for the agriculture, forestry, fishing and hunting industry, leaving a "NA" instead.
