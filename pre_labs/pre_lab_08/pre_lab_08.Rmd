...
census_api_key("8b69f2765f65670c2183febdffce6afc73c72101", install=TRUE)
...
**Answer** No, because the estimates/margin of errors overlap.

Is the difference between Howard and everyone else significant?
**Answer** Yes, because the estimate/margin of errors do not overlap with any other counties.
...
**Answer** Somerset and Caroline counties. Although the margin of error isn't included in the tibble, I would imagine that Somerset's change is outside of the margin error since median income saw a roughly -10.9% change from 2010-2019.
...
**Answer** 21202 -> $47,848, 21740 -> $48,372, 21201 -> $37,687
