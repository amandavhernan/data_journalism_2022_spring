...
**Answer** https://datawrapper.dwcdn.net/jcUjd/1/
...
**Answer** The code below groups Maryland county names and counts how many PPP loans were applied for in each jurisdiction. Some of the issues with the dataset include county data for counties outside of Maryland (e.g., Broward, Middlesex, Portsmouth City)
...
**Answer** The code below filters out the counties that have less than 6 loans, which removes the counties not located in Maryland.
...
**Answer** The new "flips_code" column is a combination of the state and county code for each record. 
...
**Answer** The new "md_counties_with_fips" dataset now includes the number of PPP loans per county in addition to the flip code, which means it's ready to be imported to Datawrapper.
...
**Answer** The first map was a map of the entire United States by county. The new map, which was generated after clicking "Hide regions without data," only shows Maryland counties.
...
**Answer** By customizing the tooltips, the map now provides better context in a more readable format.
...
**Answer** https://datawrapper.dwcdn.net/SO0FE/2/
